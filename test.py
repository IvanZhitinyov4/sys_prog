...
class TestComplex(unittest.TestCase):
    ...
    def test_multiplication(self):
        ...
        c2 = Complex(Rational(1, 4), Rational(1, 5))
        result = c1 * c2
        self.assertEqual(result.real.fraction, Fraction(-1, 60))
    ...
    def test_division(self):
        ...
        c2 = Complex(Rational(1, 4), Rational(1, 5))
        result = c1 / c2
        self.assertEqual(result.real.fraction, Fraction(22, 17))
        self.assertEqual(result.imag.fraction, Fraction(2, 85))
    ...
    def test_power(self):
        c1 = Complex(Rational(1, 2), Rational(1, 3))
        result = c1.pow(2)
        self.assertEqual(result.real.fraction, Fraction(-1, 36))
        self.assertEqual(result.imag.fraction, Fraction(1, 9))

    def test_arg_and_abs(self):
        c1 = Complex(Rational(1, 2), Rational(1, 3))
        self.assertAlmostEqual(c1.arg(), 0.588002603547568)
        self.assertAlmostEqual(c1.abs(), 0.559016994374947)
